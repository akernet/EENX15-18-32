...
# Generated: Wed Apr  4 14:11:51 2018
##################################################
...
class send_and_receive_save_to_complex_4_frequencies(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_f1fas = blocks.file_sink(gr.sizeof_gr_complex*1, '/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/GNUradio-projekt/send and receive amplitude python/data/FourFrequenciesComplex.txt', False)
        ...
        self.connect((self.uhd_usrp_source_0, 0), (self.blocks_file_sink_f1fas, 0))
...
def main(top_block_cls=send_and_receive_save_to_complex_4_frequencies, options=None):
    ...
    def increment_center_frequency_and_sleep():
        ...
        seconds_per_center_freq = 1
        
        # Update the center frequency and let it run for 'seconds_per_center_freq'.
        # Then increment it with 'center_freq_step'.
        # Save each center frequency to a unique file with extension center_freq/10**6,
        # it might be easier to save all data to one file though.
        while current_center_freq <= center_freq_max:
            file_name_extension = str(int(current_center_freq/(10**6)))
            tb.blocks_file_sink_f1fas.open('/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/GNUradio-projekt/send and receive amplitude python/data/FourFrequenciesComplex' + file_name_extension + '.txt')
...
#         # Close file sink block if we save all data to one file.
#         tb.blocks_file_sink_f1fas.close()
