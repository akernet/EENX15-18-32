...
class send_and_receive_amplitude(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_f4fas = blocks.file_sink(gr.sizeof_float*1, '/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/GNUradio-projekt/send and receive amplitude GRC/data/f4.txt', False)
        self.blocks_file_sink_f4fas.set_unbuffered(False)
        self.blocks_file_sink_f3fas = blocks.file_sink(gr.sizeof_float*1, '/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/GNUradio-projekt/send and receive amplitude GRC/data/f3.txt', False)
        self.blocks_file_sink_f3fas.set_unbuffered(False)
        self.blocks_file_sink_f2fas = blocks.file_sink(gr.sizeof_float*1, '/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/GNUradio-projekt/send and receive amplitude GRC/data/f2.txt', False)
        self.blocks_file_sink_f2fas.set_unbuffered(False)
        self.blocks_file_sink_f1amp = blocks.file_sink(gr.sizeof_float*1, '/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/GNUradio-projekt/send and receive amplitude GRC/data/f1.txt', False)
...
def main(top_block_cls=send_and_receive_amplitude, options=None):
    ...
    def increment_center_frequency_and_sleep():
        ...
        seconds_to_sleep_before_start = 10
        name_of_run = '36dB_3'
        time.sleep(seconds_to_sleep_before_start)
        
        current_center_freq = tb.get_center_freq()
        center_freq_step = 4*10**6
        center_freq_max = 2*10**9
        seconds_per_center_freq = 2
        
        print('\n')
        print(tb.uhd_usrp_sink_0.get_sensor('temp'))
                
        # Update the center frequency and let it run for 'seconds_per_center_freq'.
        # Then increment it with 'center_freq_step'.
        while current_center_freq <= center_freq_max:
            file_name_extension = str(int(current_center_freq))
            tb.blocks_file_sink_f1amp.open('/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/GNUradio-projekt/send and receive amplitude python/S21_data_10_april/f1_' + file_name_extension + '_' + name_of_run + '.txt')
            tb.blocks_file_sink_f2fas.open('/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/GNUradio-projekt/send and receive amplitude python/S21_data_10_april/f2_' + file_name_extension + '_' + name_of_run + '.txt')
            tb.blocks_file_sink_f3fas.open('/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/GNUradio-projekt/send and receive amplitude python/S21_data_10_april/f3_' + file_name_extension + '_' + name_of_run + '.txt')
            tb.blocks_file_sink_f4fas.open('/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/GNUradio-projekt/send and receive amplitude python/S21_data_10_april/f4_' + file_name_extension + '_' + name_of_run + '.txt')
            tb.set_center_freq(current_center_freq)
            print('\n Current center frequency: {}'.format(tb.get_center_freq()))
            time.sleep(seconds_per_center_freq)
        ...
        print('Stopped saving data to file')
