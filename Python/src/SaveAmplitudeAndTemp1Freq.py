...
# This line has been added from the grc-generated Python file.
import thread
...
class measure_temperature_and_amplitude(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_float*1, '/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/Experimentdata/Temperaturmatning/April 27/amplitude3.txt', False)
...
def main(top_block_cls=measure_temperature_and_amplitude, options=None):
    ...
    def measure_and_save_temp():
        ...
        # Variables
        sleep_time_before_start = 0
        time.sleep(sleep_time_before_start)
        sleep_time_between_measurements = 0.3
        i_temp = 0
        temp_loops = 100
        temp_file = open('/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/Experimentdata/Temperaturmatning/April 27/tempdata3.txt', 'w')
        
        # Check and save the temperature of the card every 0.3 seconds.
        while(i_temp <= temp_loops):
            temp_file.write(str(tb.uhd_usrp_sink_0.get_sensor('temp')))
            temp_file.write('\n')
            time.sleep(sleep_time_between_measurements)
            i_temp += 1
            
        # Close amplitude data file and temperature data file.
        tb.blocks_file_sink_1.close()
        temp_file.close()
