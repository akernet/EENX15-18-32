...
class send_and_receive_amplitude_and_phase(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_f4fas = blocks.file_sink(gr.sizeof_float*1, '/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/GNUradio-projekt/send and receive amplitude GRC/data/f4fas.txt', False)
        self.blocks_file_sink_f4fas.set_unbuffered(False)
        self.blocks_file_sink_f3fas = blocks.file_sink(gr.sizeof_float*1, '/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/GNUradio-projekt/send and receive amplitude GRC/data/f3fas.txt', False)
        self.blocks_file_sink_f3fas.set_unbuffered(False)
        self.blocks_file_sink_f2fas = blocks.file_sink(gr.sizeof_float*1, '/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/GNUradio-projekt/send and receive amplitude GRC/data/f2fas.txt', False)
        self.blocks_file_sink_f2fas.set_unbuffered(False)
        self.blocks_file_sink_f4amp = blocks.file_sink(gr.sizeof_float*1, '/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/GNUradio-projekt/send and receive amplitude GRC/data/f4amp.txt', False)
        self.blocks_file_sink_f4amp.set_unbuffered(False)
        self.blocks_file_sink_f3amp = blocks.file_sink(gr.sizeof_float*1, '/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/GNUradio-projekt/send and receive amplitude GRC/data/f3amp.txt', False)
        self.blocks_file_sink_f3amp.set_unbuffered(False)
        self.blocks_file_sink_f2amp = blocks.file_sink(gr.sizeof_float*1, '/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/GNUradio-projekt/send and receive amplitude GRC/data/f2amp.txt', False)
        self.blocks_file_sink_f2amp.set_unbuffered(False)
        self.blocks_file_sink_f1amp = blocks.file_sink(gr.sizeof_float*1, '/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/GNUradio-projekt/send and receive amplitude GRC/data/f1amp.txt', False)
        self.blocks_file_sink_f1amp.set_unbuffered(False)
        self.blocks_file_sink_f1fas = blocks.file_sink(gr.sizeof_float*1, '/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/GNUradio-projekt/send and receive amplitude GRC/data/f1fas.txt', False)
        self.blocks_file_sink_f1fas.set_unbuffered(False)
        ...
        self.connect((self.blocks_complex_to_arg_0, 0), (self.blocks_file_sink_f1fas, 0))
        self.connect((self.blocks_complex_to_arg_0_0, 0), (self.blocks_file_sink_f2fas, 0))
        self.connect((self.blocks_complex_to_arg_1, 0), (self.blocks_file_sink_f4fas, 0))
        self.connect((self.blocks_complex_to_arg_2, 0), (self.blocks_file_sink_f3fas, 0))
        ...
        self.connect((self.blocks_complex_to_mag_0_0, 0), (self.blocks_file_sink_f2amp, 0))
        self.connect((self.blocks_complex_to_mag_0_0, 0), (self.qtgui_number_sink_0_0, 0))
        self.connect((self.blocks_complex_to_mag_0_0_0, 0), (self.blocks_file_sink_f3amp, 0))
        self.connect((self.blocks_complex_to_mag_0_0_0, 0), (self.qtgui_number_sink_0_0_0, 0))
        self.connect((self.blocks_complex_to_mag_0_0_1, 0), (self.blocks_file_sink_f4amp, 0))
...
def main(top_block_cls=send_and_receive_amplitude_and_phase, options=None):
    ...
    #---------------------------------------------------------------
    def measure_ref_and_phantom():
        
        # Variables
        folderPath = '/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/Experimentdata/Data April 27/'
        name_of_run = 'ref_far_2'
        center_freq = 2e9                   # 1, 1.5, 2
        tb.set_center_freq(center_freq)
        file_name_extension = str(int(center_freq))
        seconds_per_measurement = 10
        
        # Reference measurement
        raw_input('Press enter when you want to start measuring the reference')
        print('Starting')
        
        # Open files
        tb.blocks_file_sink_f1amp.open(folderPath + 'f1amp_' + file_name_extension + '_' + name_of_run + '.txt')
        tb.blocks_file_sink_f2amp.open(folderPath + 'f2amp_' + file_name_extension + '_' + name_of_run + '.txt')
        tb.blocks_file_sink_f3amp.open(folderPath + 'f3amp_' + file_name_extension + '_' + name_of_run + '.txt')
        tb.blocks_file_sink_f4amp.open(folderPath + 'f4amp_' + file_name_extension + '_' + name_of_run + '.txt')
        tb.blocks_file_sink_f1fas.open(folderPath + 'f1fas_' + file_name_extension + '_' + name_of_run + '.txt')
        tb.blocks_file_sink_f2fas.open(folderPath + 'f2fas_' + file_name_extension + '_' + name_of_run + '.txt')
        tb.blocks_file_sink_f3fas.open(folderPath + 'f3fas_' + file_name_extension + '_' + name_of_run + '.txt')
        tb.blocks_file_sink_f4fas.open(folderPath + 'f4fas_' + file_name_extension + '_' + name_of_run + '.txt')
        
        time.sleep(seconds_per_measurement)
        
        # Close files
        tb.blocks_file_sink_f1amp.close()
        tb.blocks_file_sink_f2amp.close()
        tb.blocks_file_sink_f3amp.close()
        tb.blocks_file_sink_f4amp.close()
        tb.blocks_file_sink_f1fas.close()
        ...
        # Phantom measurement
        # Wait for user input
        raw_input('Press enter when you are ready for the phantom measurement')
        print('Starting')
        
        name_of_run = 'phantom_far_2'
    ...
    thread.start_new_thread(measure_ref_and_phantom, ())
    # End of addition
    #---------------------------------------------------------------
