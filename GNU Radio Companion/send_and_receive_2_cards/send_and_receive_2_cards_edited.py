...
# Title: Send And Receive 2 Cards
# Generated: Mon Mar 26 10:50:13 2018
##################################################
...
class send_and_receive_2_cards(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Send And Receive 2 Cards")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Send And Receive 2 Cards")
        ...
        self.settings = Qt.QSettings("GNU Radio", "send_and_receive_2_cards")
...
def main(top_block_cls=send_and_receive_2_cards, options=None):
    ...
    def sleep_and_switch_receiver_antenna():
        time.sleep(5)
        print('Nu byter vi port')
        tb.uhd_usrp_source_0.set_antenna('TX/RX', 0)

    thread.start_new_thread(sleep_and_switch_receiver_antenna, ())
