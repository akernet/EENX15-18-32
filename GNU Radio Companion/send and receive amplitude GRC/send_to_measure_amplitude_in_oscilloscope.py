...
# Title: Send To Measure Amplitude In Oscilloscope
# Generated: Wed Apr  4 13:14:33 2018
##################################################
...
class send_to_measure_amplitude_in_oscilloscope(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Send To Measure Amplitude In Oscilloscope")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Send To Measure Amplitude In Oscilloscope")
        ...
        self.settings = Qt.QSettings("GNU Radio", "send_to_measure_amplitude_in_oscilloscope")
...
def main(top_block_cls=send_to_measure_amplitude_in_oscilloscope, options=None):
