...
# Title: Send And Receive Save To Complex
# Generated: Wed Apr  4 13:15:28 2018
##################################################
...
class send_and_receive_save_to_complex(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Send And Receive Save To Complex")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Send And Receive Save To Complex")
        ...
        self.settings = Qt.QSettings("GNU Radio", "send_and_receive_save_to_complex")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/Users/arvidbjurklint/Google Drive/Kandidatarbete-Software defined radio/GNUradio-projekt/send and receive amplitude/data_26_1/antennaFar2CrossFirst.txt', False)
...
def main(top_block_cls=send_and_receive_save_to_complex, options=None):
