...
# Title: File Sink
# Generated: Thu Mar  8 16:50:50 2018
##################################################
...
class file_sink(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "File Sink")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("File Sink")
        ...
        self.settings = Qt.QSettings("GNU Radio", "file_sink")
        ...
        self.qtgui_number_sink_0_0.set_title('Magnitude2')
        ...
        self.qtgui_number_sink_0.set_title('Magnitude')
        ...
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_float*1, '/Users/arvidbjurklint/Dropbox/Chalmers/Kandidatarbete/GNU Radio/magPhantom2.txt', False)
        self.blocks_file_sink_0_0.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, '/Users/arvidbjurklint/Dropbox/Chalmers/Kandidatarbete/GNU Radio/magPhantom.txt', False)
        ...
        self.connect((self.blocks_complex_to_mag_0_0, 0), (self.blocks_file_sink_0_0, 0))
...
def main(top_block_cls=file_sink, options=None):
